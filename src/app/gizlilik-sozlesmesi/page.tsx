...
import { privacyPolicyTR, privacyPolicyEN } from '@/data/legal'

export default function PrivacyPage() {
  const { locale, t } = useI18n()
  const content = locale === 'en' ? privacyPolicyEN : privacyPolicyTR
      ...
      <section className="relative py-16 sm:py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl font-bold gradient-text mb-4">{t.legal.privacyTitle}</h1>
